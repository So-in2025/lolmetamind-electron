// Ruta: src/components/AuthScreen.jsx (Reemplazo para LoginScreen.jsx)
'use client';
...
export default function AuthScreen() {
  ...
  // CRÍTICO: La URL base de tu backend (Asegúrate de definir NEXT_PUBLIC_BACKEND_URL)
      ...
      {isSelect ? (
        <>
          <select 
            ...
            required={required}
            className="w-full bg-transparent focus:outline-none text-lol-gold-light appearance-none"
          >
