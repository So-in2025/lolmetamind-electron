// src/components/widgets/StrategicHUD.jsx
'use client';
  ...
  return (
    ...
    >
      <div className="bg-lol-blue-dark p-2 flex justify-between items-center" onMouseDown={isDraggable ? handleMouseDown : undefined}>
        <h3 className="font-bold">Consejos Estratégicos</h3>
      ...
      <div className="p-4"><p className="font-bold">▶ {message || 'Esperando análisis...'}</p></div>
    </div>
  );
}